...
export function ManualIcon({ size = 44 }: IconProps) {
  return (
...
export function WrenchIcon({ size = 15 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path
        d="M14.7 6.3a4 4 0 0 0-5.6 4.9L2 18.3l1.7 1.7 7.1-7.1a4 4 0 0 0 4.9-5.6l-2.5 2.5-2-2Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function LinkIcon({ size = 15 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M9 17H7a5 5 0 0 1 0-10h2M15 7h2a5 5 0 0 1 0 10h-2M8 12h8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
